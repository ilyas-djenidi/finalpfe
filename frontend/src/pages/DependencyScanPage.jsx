...
import {
    ...
    FileText, X, AlertTriangle, Terminal, ChevronRight, Download
} from 'lucide-react';
                                ...
                                <div className="bg-purple-50 dark:bg-purple-500/5 border border-purple-200 dark:border-purple-500/20 rounded-xl p-6 shadow-sm">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-purple-600/80 dark:text-purple-400/80 mt-1">AI-powered dependency vulnerability triage.</p>
                                        </div>
                                        <button
